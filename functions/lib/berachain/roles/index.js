...
exports.manualQualityScoresUpdateV2 = exports.scheduledQualityScoresUpdateV2 = exports.updateQualityScores = exports.manualRoleStatsUpdateV2 = exports.scheduledRoleStatsUpdateV2 = exports.manualRolesUpdateV2 = exports.scheduledRolesUpdateV2 = void 0;
...
async function updateDiscordRoles() {
    ...
    `;
        ...
        try {
            ...
            console.log('Query executed successfully, row count:', rows === null || rows === void 0 ? void 0 : rows.length);
        }
        catch (queryError) {
 ...
 */
async function processAndUpdateFirebase(rows) {
    try {
 ...
 */
function generateSearchTokens(username) {
 ...
 */
exports.scheduledRolesUpdateV2 = (0, scheduler_1.onSchedule)({
    schedule: "*/30 * * * *",
    timeZone: "UTC",
    memory: "256MiB",
    maxInstances: 1,
 ...
 */
exports.manualRolesUpdateV2 = (0, https_1.onRequest)({
    memory: "256MiB",
    maxInstances: 1,
    cors: true,
    region: "us-central1",
...
exports.updateQualityScores = updateQualityScores;
/**
 * Scheduled function that runs every 2 hours to update quality scores
 */
exports.scheduledQualityScoresUpdateV2 = (0, scheduler_1.onSchedule)({
    schedule: "0 */2 * * *",
    timeZone: "UTC",
    memory: "256MiB",
    maxInstances: 1,
 ...
 */
exports.manualQualityScoresUpdateV2 = (0, https_1.onRequest)({
    memory: "256MiB",
    maxInstances: 1,
    cors: true,
    region: "us-central1",
