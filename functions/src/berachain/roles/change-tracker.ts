 ...
 */
export async function updateRoleChangeTracker() {
 ...
 */
export const scheduledRoleChangeTrackerUpdateV2 = onSchedule({
 ...
 */
export const manualRoleChangeTrackerUpdateV2 = onRequest({
  memory: "256MiB",
  maxInstances: 1,
  cors: true,
  region: "us-central1",
